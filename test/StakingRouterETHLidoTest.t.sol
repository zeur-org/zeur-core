...
import {StakingRouterETHEtherfiV2} from "./mock-v2/StakingRouterETHEtherfiV2.sol";
...
contract StakingRouterETHLidoTest is Test {
    StakingRouterETHLido private stakingRouter;
    MockLido private stETH;
    ...
    function setUp() public {
        ...
        stakingRouter = stakingRouters.stakingRouterETHLido;
    ...
    function test_getStakedToken() public view {
        assertEq(stakingRouter.getStakedToken(), address(stETH));
    }
    ...
    function test_getStakedTokenAndExchangeRate() public view {
        ...
        assertEq(stakedToken, address(stETH));
    ...
    function test_Upgrade() public {
        ...
        StakingRouterETHEtherfiV2 newStakingRouterImpl = new StakingRouterETHEtherfiV2();
        stakingRouter.upgradeToAndCall(address(newStakingRouterImpl), "");

        StakingRouterETHEtherfiV2 newStakingRouter = StakingRouterETHEtherfiV2(
